...
//
//==================================================================================================
class RiuSummaryQwtCrossPlot : public QwtPlot, public RiuInterfaceToViewWindow
{
    Q_OBJECT;
public:
    RiuSummaryQwtCrossPlot(RimSummaryCrossPlot* plotDefinition, QWidget* parent = NULL);
    virtual ~RiuSummaryQwtCrossPlot();

    RimSummaryCrossPlot*            ownerPlotDefinition();
...
private:
    caf::PdmPointer<RimSummaryCrossPlot> m_plotDefinition;
