...
/// 
//--------------------------------------------------------------------------------------------------
RiuSummaryQwtCrossPlot::RiuSummaryQwtCrossPlot(RimSummaryCrossPlot* plotDefinition, QWidget* parent) : QwtPlot(parent)
{
...
/// 
//--------------------------------------------------------------------------------------------------
RiuSummaryQwtCrossPlot::~RiuSummaryQwtCrossPlot()
{
    if (m_plotDefinition)
    {
...
/// 
//--------------------------------------------------------------------------------------------------
RimSummaryCrossPlot* RiuSummaryQwtCrossPlot::ownerPlotDefinition()
{
...
/// 
//--------------------------------------------------------------------------------------------------
RimViewWindow* RiuSummaryQwtCrossPlot::ownerViewWindow() const
{
    return m_plotDefinition;
}
...
/// 
//--------------------------------------------------------------------------------------------------
void RiuSummaryQwtCrossPlot::currentVisibleWindow(QwtInterval* leftAxis, QwtInterval* rightAxis, QwtInterval* timeAxis) const
{
...
/// 
//--------------------------------------------------------------------------------------------------
void RiuSummaryQwtCrossPlot::setZoomWindow(const QwtInterval& leftAxis, const QwtInterval& rightAxis, const QwtInterval& timeAxis)
{
    {
        QRectF zoomWindow;
...
/// 
//--------------------------------------------------------------------------------------------------
QSize RiuSummaryQwtCrossPlot::minimumSizeHint() const
{
    return QSize(0, 100);
}
...
/// 
//--------------------------------------------------------------------------------------------------
void RiuSummaryQwtCrossPlot::contextMenuEvent(QContextMenuEvent* event)
{
    QMenu menu;
...
/// 
//--------------------------------------------------------------------------------------------------
QSize RiuSummaryQwtCrossPlot::sizeHint() const
{
    return QSize(0, 0);
}
...
/// 
//--------------------------------------------------------------------------------------------------
void RiuSummaryQwtCrossPlot::setDefaults()
{
...
void RiuSummaryQwtCrossPlot::setCommonPlotBehaviour(QwtPlot* plot)
{
...
/// 
//--------------------------------------------------------------------------------------------------
void RiuSummaryQwtCrossPlot::useDateBasedTimeAxis()
{
...
/// 
//--------------------------------------------------------------------------------------------------
void RiuSummaryQwtCrossPlot::enableDateBasedBottomXAxis(QwtPlot* plot)
{
...
/// 
//--------------------------------------------------------------------------------------------------
void RiuSummaryQwtCrossPlot::useTimeBasedTimeAxis()
{
...
/// 
//--------------------------------------------------------------------------------------------------
bool RiuSummaryQwtCrossPlot::eventFilter(QObject* watched, QEvent* event)
{
    if(watched == canvas())
    {
...
/// 
//--------------------------------------------------------------------------------------------------
void RiuSummaryQwtCrossPlot::selectClosestCurve(const QPoint& pos)
{
...
/// 
//--------------------------------------------------------------------------------------------------
void RiuSummaryQwtCrossPlot::onZoomedSlot()
{
...
/// 
//--------------------------------------------------------------------------------------------------
void RiuSummaryQwtCrossPlot::onAxisClicked(int axis, double value)
{
